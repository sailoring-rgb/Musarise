...
class ScreenRecorder: NSObject, ObservableObject, RPPreviewViewControllerDelegate {
    ...
    func saveSoundInFirebase(instrumentName: String, instrumentIcon: String, soundTitle: String, soundDescription: String){
        self.uploadRecordingToFirebase { result in
           switch result {
           case .success(let downloadURL):
               print("Upload successful. Download URL: \(downloadURL)")
               
               let playgroundSound = PlaygroundSound(soundURL: downloadURL, instrumentName: instrumentName, instrumentIcon: instrumentIcon,userid: self.userUID, soundTitle: soundTitle, soundDescription: soundDescription)
